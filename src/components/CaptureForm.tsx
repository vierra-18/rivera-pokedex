					...
					<motion.div className="fixed inset-0 flex items-center justify-center bg-black backdrop-blur-lg bg-opacity-80 z-50">
						{!isCaptured ? (
							<motion.fieldset
								...
								className="bg-black/50 border border-gray-700/40  sm:pb-12 pb-[20vw] text-white flex flex-col justify-center items-center sm:flex-row gap-4 p-6 rounded-lg"
							>
							...
							<motion.fieldset
								...
								exit={{ opacity: 0, scale: 0.5 }}
								transition={{ duration: 0.3 }}
								className="bg-black/50 border border-gray-700/40  sm:pb-12 pb-[20vw]  text-white flex flex-col justify-center items-center sm:flex-row gap-4 p-6 rounded-lg shadow-lg"
							>
								<legend className="capitalize p-1 px-3 mx-auto text-white border bg-yellow-700 rounded-md ">{`${nickname.join(
									""
